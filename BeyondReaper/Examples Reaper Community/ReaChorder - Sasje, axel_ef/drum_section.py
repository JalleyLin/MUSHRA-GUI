...
class DrumSection(RSStateManager):
    ...
    def init_widgets(self):
        ...
        self._label_1 = tkinter.Label(self.grid, text = "Draw:",bg="#E8E8E8"
        )
        self._label_4 = tkinter.Label(self.grid,
            text = "Tom 2",bg="#E8E8E8",font=("System 12"),
        )
        self._label_5 = tkinter.Label(self.grid,
            text = "Tom 1",bg="#E8E8E8",font=("System 12"),
        )
        self._label_6 = tkinter.Label(self.grid,
            text = "Splash",bg="#E8E8E8",font=("System 12"),
        )
        self._label_7 = tkinter.Label(self.grid,
            text = "Ride",bg="#E8E8E8",font=("System 12"),
        )
        self._label_8 = tkinter.Label(self.grid,
            text = "HH Cl.",bg="#E8E8E8",font=("System 12"),
        )
        self._label_9 = tkinter.Label(self.grid,
            text = "HH Op.",bg="#E8E8E8",font=("System 12"),
        )
        self._label_10 = tkinter.Label(self.grid,
            text = "Snare",bg="#E8E8E8",font=("System 12"),
        )
        self._label_11 = tkinter.Label(self.grid,
            text = "Kick",bg="#E8E8E8",font=("System 12"),
        )
